...
runCommand "spore-disk"
  ...
  ''
    ...
    label: gpt
    label-id: 73706F72-6500-0000-0000-000000000000
    start=4096, size=262144, type=uefi, uuid=73706F72-6500-0000-0000-000000000001, name=ESP
    start=2048, size=2048, type=21686148-6449-6E6F-744E-656564454649, uuid=73706F72-6500-0000-0000-000000000002, name=bios
    EOF
    truncate -s 128M esp.img
    mkfs.vfat -F 32 -n ESP -i 73706f72 esp.img > /dev/null
